...
public class Main {
    ...
    private static final String startPath = "src/test/k/";
    ...
    private static String process(File f) {
		String koreParserCWD = "/home/pmeredit/K/kore/src/main/haskell/language-kore";
        ...
        String termination = ".kore.info";
		File fl = new File(f.getAbsolutePath() + termination);
        FileUtil.save(fl, str);
		System.out.println(fl.getAbsolutePath());
        try {
            RunProcess.ProcessOutput po = RunProcess.execute(new HashMap<>(), new File(koreParserCWD), "/usr/local/bin/stack", "exec", "--", "kore-parser", fl.getAbsolutePath());
			System.out.println(new String(po.stderr));
